...
type KindEntry = {
  label: string;
  /**
   * ماذا يعطيك هذا النمط اليوم وماذا لا يعطيك — **بلغة المُعِدّ**.
   * لا وسم «(محجوز)» غامض يترك القارئ يخمّن ما ينقصه.
   */
  lede: string;
...
export const PROGRAM_KINDS = {
  competition: {
    label: "مسابقة",
    lede: "مسارات ومادة وخطة يومية، ومعها اختبارات وتصفيات وعتبات اجتياز وجوائز.",
    built: true,
    scored: true,
    exams: true,
  ...
  weekly_followup: {
    ...
    lede:
      "مسارات ومادة وخطة، بلا اختبارات ولا عتبات. " +
      "**والخطة يومية لا أسبوعية بعد** — الجدولة الأسبوعية لم تُبنَ.",
    built: false,
    scored: false,
    exams: false,
  ...
  remote_memorization: {
    ...
    lede:
      "مسارات ومادة وخطة، بلا اختبارات ولا عتبات. " +
      "**وآلية التحقق الخاصة به لم تُبنَ** — الإتمام بعلامة كغيره.",
    built: false,
    scored: false,
    exams: false,
    statuses: OPEN_STATUSES,
